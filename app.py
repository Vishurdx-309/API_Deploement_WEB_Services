...
def generate_product_details(sample_file):
    ...
    -category of the product among the following list of categories: {"Personal Care", "Household Care", "Dairy", "Staples", "Snacks and Beverages", "Packaged Food", "Fruits and Vegetables"}. Return 'NA' if the category is not determined.
...
# # Configure the API key
# api_key = 'AIzaSyBI5gPiAi9Zhpfnxp8slfxiCy3j9jZL12E'  # Replace with your actual API key
# genai.configure(api_key=api_key)
...
# # Configure the API key
# api_key = 'AIzaSyC6Ixo9L5mD_7s4v2CP1ag3mlDn2xygAj8'  # Replace with your actual API key
# genai.configure(api_key=api_key)
...
#     - whether it is expired ("YES" or "NO" if expiry date detected, else NA)
#     - expected life span in days (Calculate the number of days remaining until the expiry date detected in format dd-mm-yyyy from date 16-12-2024, or "NA" if expired)
#     -category of the product among the following list of categories: {"Personal Care", "Household Care", "Dairy", "Staples", "Snacks and Beverages", "Packaged Food", "Fruits and Vegetables"} only.Return 'NA' if the category is not determined.
...
# # # Configure the API key
# # api_key = 'AIzaSyDf0uRDJjVyCIfp-TNfo1o_ZzQqZp7UKr4'  # Replace with your actual API key
# # genai.configure(api_key=api_key)
